...
insert into rental values(0003, 900, '02-25-2019', '02-27-2019', 310, 12, 2, 2771);
insert into rental values(0004, 2625, '06-02-2015', '06-07-2015', 636, 13, 2, 2771);
insert into rental values(0005, 1234, '05-30-2014', '06-05-2014', 1003, 14, 0, 0002);
insert into rental values(0006, 355, '02-05-2019', '02-10-2019', 37, 15, 0, 0003);
insert into rental values(0007, 134, '03-14-2019', '03-15-2019', 147, 16, 0, 0004);
insert into rental values(0008, 189, '03-15-2019', '03-17-2019', 259, 17, 0, 0001);
insert into rental values(0009, 350, '03-20-2019', '03-22-2019', 500, 18, 2, 2771);
--
SET FEEDBACK ON
COMMIT;
--
...
*/
SELECT C.licensePlateNum, C.carModel, C.year, SUM(R.rCost)
FROM car C, rental R
